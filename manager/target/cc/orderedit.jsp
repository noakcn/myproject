                            ...
                            <sf:form id="tz" class="form-horizontal" action="/operator/order/do/edit.do" method="get"
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="day_number"
                                                   class="input-xlarge focused" value="${order.day_number}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="customer_name"
                                                   class="input-xlarge focused" value="${order.customer.name}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="mobile"
                                                   class="input-xlarge focused" value="${order.customer.mobile}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="identity"
                                                   class="input-xlarge focused" value="${order.customer.identity}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">押金</label>
                                        <div class="controls">
                                            <input name="yajin" class="input-xlarge focused" value="${order.yajin}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="offer" class="input-xlarge focused" value="${order.off}">
                                        </div>
                                    </div>
